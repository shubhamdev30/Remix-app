...
export default async function OrdersMerge(columndata,activecolumns,currency,countryCode,currencysymbol,collectionwithlineitem) {

// console.log(activecolumns);
// console.log(currency);
// console.log(countryCode);
// console.log(currencysymbol);
// console.log(collectionwithlineitem.length);
// Remove leading and trailing \"
// columndata = columndata.trim();
// const parsedObject = JSON.parse(columndata);
// console.log(columndata);
// const parsedArray = dataArray.map(str => JSON.parse(str.trim()));
...
function replaceNullWithNA(array) {
  ...
  const initiallySortedRows = replaceNullWithNA(collectionwithlineitem);
